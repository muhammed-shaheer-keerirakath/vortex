...
describe('Misc', () => {
  ...
  describe('web3_clientVersion', () => {
    it('should get correct remix simulator version', async () => {
      web3['_requestManager']
        .send({ method: 'web3_clientVersion', params: [] })
        .then((version) => {
  ...
  describe('zond_protocolVersion', () => {
    it('should get protocol version', async () => {
      web3['_requestManager']
        .send({ method: 'zond_protocolVersion', params: [] })
  ...
  describe('web3_sha3', () => {
    it('should get result of a sha3', async () => {
      web3['_requestManager']
        .send({ method: 'web3_sha3', params: ['0x68656c6c6f20776f726c64'] })
  ...
  describe('zond_getCompilers', () => {
    it('should get list of compilers', async () => {
      web3['_requestManager']
        .send({ method: 'zond_getCompilers', params: [] })
  ...
  describe('zond_compileSolidity', () => {
    it('get unsupported result when requesting solidity compiler', async () => {
      web3['_requestManager']
        .send({ method: 'zond_compileSolidity', params: [] })
  ...
  describe('zond_compileLLL', () => {
    it('get unsupported result when requesting LLL compiler', async () => {
      web3['_requestManager']
        .send({ method: 'zond_compileLLL', params: [] })
        .then((result) => assert.equal(result, 'unsupported'))
        .catch((err) => {
          throw new Error(err)
        })
  ...
  describe('zond_compileSerpent', () => {
    it('get unsupported result when requesting serpent compiler', async () => {
      web3['_requestManager']
        .send({ method: 'zond_compileSerpent', params: [] })
        .then((result) => assert.equal(result, 'unsupported'))
        .catch((err) => {
          throw new Error(err)
        })
